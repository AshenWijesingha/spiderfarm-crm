...
from leads.views import (
    ...
    update_lead, DeleteLeadView, convert_lead, AssignLeadsView,
...
urlpatterns = [
    ...
    path('assign/', AssignLeadsView.as_view(), name='assign_leads'),
    path('get/list/', GetLeadsView.as_view(), name="get_lead"),
    path('export/', ExportLeadsView.as_view(), name="export_leads"),
